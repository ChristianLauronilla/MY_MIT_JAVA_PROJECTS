...
public class MyClass {
	...
	public MyClass(String section_name, String teacher_username, String student_name, String student_id, String class_status) {
		super();
	...
	public MyClass(String teacher_username) {
		super();
		this.teacher_username = teacher_username;
	}
