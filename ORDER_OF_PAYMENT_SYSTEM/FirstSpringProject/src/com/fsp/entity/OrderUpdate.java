...
public class OrderUpdate {
	...
	public OrderUpdate(String entity_name, String serial_no, String fund_cluster, String date_encoded, String payor_name,
	...
	public OrderUpdate(String entity_name, String approved_by) {
		super();
		this.entity_name = entity_name;
		this.approved_by = approved_by;
	}
	
	public OrderUpdate(String entity_name) {
		super();
		this.entity_name = entity_name;
	}
